...
class cityscapesLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        lbl = scipy.misc.imread(lbl_path)
    ...
    def transform(self, img, lbl):
        ...
        img -= self.mean
        img = scipy.misc.imresize(img, (self.img_size[0], self.img_size[1]))
        ...
        lbl = scipy.misc.imresize(lbl, (self.img_size[0], self.img_size[1]), 'nearest', mode='F')
        lbl = lbl.astype(int)
