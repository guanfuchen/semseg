...
def Res_Deeplab(n_classes=21, is_refine=False):
    if is_refine:
...
def Res_Deeplab_50(n_classes=21, is_refine=False):
    if is_refine:
...
def Res_Deeplab_101(n_classes=21, is_refine=False):
    if is_refine:
        model = ResNet_Refine(Bottleneck, [3, 4, 23, 3], n_classes)
    else:
        model = ResNet(Bottleneck, [3, 4, 23, 3], n_classes)
...
if __name__ == '__main__':
    batch_size = 1
    n_classes = 21
    model = Res_Deeplab_101(n_classes=n_classes, is_refine=False)
